...
// Este componente se personalizará una vez que sepamos exactamente qué 
// estructura tienen los datos de detalle de orden que devuelve la API
  ...
  return (
    <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700">
      ...
      <div className="space-y-3">
        ...
        {/* Aquí se renderizarán otros campos según la estructura real de datos */}
